...
$checkallairline = $this->input->post('checkallairline');
                        ...
                        <div class="form-group" style="margin-top: 50px;">
                            <div class="col-xs-8">
                                ...
                                <div class="i-checks-all-airline">
                                    <label>
                                        <input type="checkbox" name="checkallairline" class="checkallairline" id="checkallairline" <?php if($checkallairline == 'on') echo 'checked';?>>
                                        <i></i>
                                ...
                                if ($config != null){
                                    ...
                                    <div class="alert alert-warning alert-dismissable">
                                        ...
                                        Mohon maaf, karena ini anda tidak bisa melakukan pencarian jadwal penerbangan
                                    </div>
                                    <?php
