...
<!--                    --><?php //echo $this->session->userdata('tokenft'); ?>
                    <form id="formpesantiket" class="form-horizontal" method="post" action="pesawat/cari_jadwal" autocomplete="off">
                        <input type="hidden" id="txbbelummemilihairline" value="<?php echo $this->session->flashdata('airlinebelumdipilih') ?>">
                        ...
                        <div class="form-group" style="margin-top: 50px;">
                            <div class="col-xs-8">
                                <div class="i-checks-all-airline">
                                    <label>
                                        <input type="checkbox" name="checkallairline" class="checkallairline" id="checkallairline">
                                        <i></i>
                                        <span style="color: <?php echo $warna_lembaga; ?>;">Pilih Semua Airline</span>
                                    </label>
                                </div><br/>
                            ...
                            <div class="col-xs-4">
                                <button class="ladda-button btn btn-danger" type="submit" data-style="zoom-in" style="display: block; width: 100%;" <?php echo $disabled;?>>Cari Jadwal</button>
                            </div>
                        </div>
