    ...
    <div class="wrapper wrapper-content article" style="margin-top: 20px;">
        <div class="row">
            ...
            <div class="col-lg-6">
                ...
                <input type="hidden" id="txbcancelbookberhasil" value="<?php echo $this->session->flashdata('messagecancel') ?>">
                ...
                <?php if($this->session->flashdata('messagecancel')){ ?>
                    <div class="alert alert-success alert-dismissable">
                        ...
                        Anda telah berhasil membatalkan Transaksi Hotel.
                    </div>
                <?php } ?>
                                            ...
                                            <form autocomplete="off">
                                                <div class="input-group">
                                                    ...
                                                    <div class="input-group-btn">
                                                        <button class="btn btn-lg btn-danger" type="button" onclick="searchcityhotel()" <?php echo $disabled;?>>
                                                            Search
                                                        </button>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-lg-12" id="popularList">
                                                ...
                                                <table class="table table-responsive">
                                                    ...
                                                    if($data_popular == null){
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div id="alertapipopular" class="alert alert-warning alert-dismissable">
                                                                    <button aria-hidden="true" data-dismiss="alert" class="close" type="button">×</button>
                                                                    Terjadi kesalahan API pada proses pemanggilan data destinasi populer<br/>
...
<!--                             --><?php //echo $this->session->userdata('tokenft') ?>
                            ...
                            <div class="form-group">
                                <div class="col-lg-12">
                                    <input class="btn btn-danger" type="button" id="btncarihotel" value="Cari Hotel" style="display: block; width: 100%;" onclick="submitcarihotel()" <?php echo $disabled;?>>
                                </div>
                            </div>
