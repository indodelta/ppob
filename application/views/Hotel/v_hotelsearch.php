    ...
    <div class="row">
        ...
        <div class="col-lg-8">
            ...
            <div class="ibox float-e-margins">
                ...
                $alamat = $this->input->post('txbalamat',true);
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-12">
                                ...
                                <input type="text"
                                       ...
                                       required>
                                <input type="hidden" id="txbgroup" name="txbgroup" value="<?php echo $jenisgroup; ?>">
                                <input type="hidden" id="txbkey" name="txbkey" value="<?php echo $key; ?>">
                ...
                if($data_api['hotel']->rc != '00') {
                    ...
                    if($jmldatahotel>0){
                                        ...
                                        <div class="ibox-content">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-4">
                                                    ...
                                                    <p class="small">
                                                        <?php 
                                                        $alamathotel = $data_api['hotel']->data[$j]->hotelAddress;
                                                        echo $alamathotel; 
                                                        ?>
                                                    </p>
                                                ...
                                                <div class="col-sm-3 text-right">
                                                    ...
                                                    if($available == 'true'){
                                                        ...
                                                        $url = 'room='.$jmlkamar.'&guest='.$jmltamu.'&checkindate='.$tglcheckin.'&checkoutdate='.$tglcheckout.'&hotel='.$idhotel.'&biller='.$idbiller.'&alamat='.$alamat.'&alamathotel='.$alamathotel;
                                                        ?>
                        ...
                        <div class="ibox-content">
                            ...
                            <form class="form-horizontal" id="formsorting" method="post" action="carihotel">

                                <input type="hidden" name="txbnamakotahotel" value="<?php echo $namakotahotel; ?>">
                                <input type="hidden" name="txbgroup" value="<?php echo $jenisgroup; ?>">
                                <input type="hidden" name="txbkey" value="<?php echo $key; ?>">
                                <input type="hidden" name="txbalamat" value="<?php echo $alamat; ?>">
                                <input type="hidden" name="txbcheckin" value="<?php echo $tglcheckin?>">
                                <input type="hidden" name="txbjmlmalam" value="<?php echo $jmlmalam?>">
                                <input type="hidden" name="txbcheckout" value="<?php echo $tglcheckout?>">
                                <input type="hidden" name="txbjmlkamar" value="<?php echo $jmlkamar?>">
                                <input type="hidden" name="txbjmltamu" value="<?php echo $jmltamu?>">

                            <?php
                                if($hasil_pencarian > 0){
                                    ?>
                                        <h2 class="col-xs-8"><?php echo $jmldatahotel-1; ?> Hotel lain ditemukan di <?php echo $data_api['param']['cityid'];?> , <?php echo $jmlavail-1; ?> Tersedia</h2>
                                    <?php
                                }else{
                                    ?>
                                        <h2 class="col-xs-8"><?php echo $jmldatahotel; ?> Hotel ditemukan di <?php echo $data_api['param']['cityid'];?> , <?php echo $jmlavail; ?> Tersedia</h2>
                                    <?php
                                }
                            ?>
                                ...
                                <div class="form-group">
                                    <div class="col-xs-4">
                                        <label class="control-label" style="color: <?php echo $warna_lembaga;?>">- Urutkan Berdasarkan -</label>
<!--                                        <select class="form-control m-b" name="sorting" id="sorting" onchange="this.form.submit()">-->
                                        <select class="form-control m-b" name="sorting" id="sorting" onchange="changesort()">
                                            <option value="1" <?php if($sort == 1){echo 'selected';} ?>>Harga: Rendah ke Tinggi</option>
                                            <option value="2" <?php if($sort == 2){echo 'selected';} ?>>Harga: Tinggi ke Rendah</option>
                                            <option value="3" <?php if($sort == 3){echo 'selected';} ?>>Peringkat: Bintang Rendah ke Tinggi</option>
                                            <option value="4" <?php if($sort == 4){echo 'selected';} ?>>Peringkat: Bintang Tinggi ke Rendah</option>
                                            <option value="5" <?php if($sort == 5){echo 'selected';} ?>>Nama: Ascending</option>
                                            <option value="6" <?php if($sort == 6){echo 'selected';} ?>>Nama: Descending</option>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <hr style="border: solid 2px <?php echo $warna_lembaga;?>">
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-4">
                                                                ...
                                                                <p class="small">
                                                                    <?php
                                                                    $alamathotel = $data_api['hotel']->data[$i]->hotelAddress;
                                                                    echo $alamathotel;
                                                                    ?>
                                                                </p>
                                                                <dl class="small m-b-none">
