...
<!--                        --><?php //echo $this->session->userdata('tokenft') ?>
                        <form id="formpesantiket" class="form-horizontal" method="post" action="pesawat/cari_jadwal" target="_blank" autocomplete="off">
                            ...
                            <div class="form-group" style="margin-top: 50px;">
                                <div class="col-xs-8">
                                                            ...
                                                            <td class="no-borders">
                                                                <div class="i-checks-airline">
                                                                    <input type="radio"
                                                                           ...
                                                                           name="airline"
                                                                           class="airline"
                                                                           data-airlineicon="<?php echo $airlineIcon;?>"
                                                                           data-airlinename="<?php echo $airlineName;?>"
                                    ...
                                    ?>
                                    <input type="hidden" id="airlineName" name="airlineName">
                                    <input type="hidden" id="airlineIcon" name="airlineIcon">
