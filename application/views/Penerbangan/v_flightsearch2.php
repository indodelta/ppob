            ...
            <div class="ibox float-e-margins">
                ...
                <div>
                    ...
                    <div class="col-sm-9">
                        ...
                        <text id="textharga0" style="font-size: 12px; margin-top: 10px; display: none;">
                            * Bila Harga yang tertera masih 0, harga akan ditampilkan di halaman selanjutnya.<br/>
                            * Harga Sewaktu-waktu bisa berubah dan Belum termasuk biaya administrasi
                        </text>

                    </div>
                    <div class="col-sm-3">

                        <form id="formsorting" method="post" action="cari_jadwal">

                            <?php
                            for ($i = 0; $i < $jmlairline; $i++) {
                                ?>
                                <input type="hidden" name="airline[]" value="<?php echo $airline[$i] ?>">
                                <?php
                            }
                            ?>
                            <input type="hidden" id="hasilsorting" value="<?php echo $hasil_sorting;?>">
                            ...
                            <div id="selectsorting" style="display: none;">
                                <select class="form-control m-b" name="sorting" id="sorting" onchange="changesort()">
                                    <option value="0" <?php if($hasil_sorting==0){echo 'selected';} ?>>- Urutkan Berdasarkan -</option>
                                    <option value="1" <?php if($hasil_sorting==1){echo 'selected';} ?>>Harga: Rendah ke Tinggi</option>
                                    <option value="2" <?php if($hasil_sorting==2){echo 'selected';} ?>>Harga: Tinggi ke Rendah</option>
                                    <option value="3" <?php if($hasil_sorting==3){echo 'selected';} ?>>Nama: Ascending</option>
                                    <option value="4" <?php if($hasil_sorting==4){echo 'selected';} ?>>Nama: Descending</option>
                                </select>
                            </div>
                ...
                <div class="ibox-content" id="iboxdatatidakditemukan" style="display: none;">
