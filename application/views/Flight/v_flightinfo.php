...
<form id="formbookpesawat" class="form-horizontal" method="post" action="booking" target="_blank" autocomplete="off" onsubmit="return confirm('Apakah data sudah terisi dengan benar?');">
                ...
                <div class="ibox-content" style="border-top: solid 1px <?php echo $warna_lembaga;?>">
                    ...
                    if($pulangpergi == 'on'){
                        ...
                        for ($a = 0; $a < $jumlahpesawatpulang; $a++) {
                            ...
                            <input type="hidden" name="<?php echo $txbflightcodetransitpulangname; ?>"
                                   value="<?php echo $flightcodetransitpulang; ?>">
                            <input type="hidden" name="<?php echo $txbtransittimepulangname; ?>"
                                   value="<?php echo $transittimepulang; ?>">
                            <input type="hidden" name="<?php echo $txbflighticontransitpulangname; ?>"
                                   value="<?php echo $flighticontransitpulang; ?>">
                            <input type="hidden" name="<?php echo $txbflightnametransitpulangname; ?>"
                                   value="<?php echo $flightnametransitpulang; ?>">
                            <input type="hidden" name="<?php echo $txbflightclasstransitpulangname; ?>"
                                   value="<?php echo $flightclasstransitpulang; ?>">
                            <input type="hidden" name="<?php echo $txbdeparttimetransitpulangname; ?>"
                                   value="<?php echo $departtimetransitpulang; ?>">
                            <input type="hidden" name="<?php echo $txbarrivaltimetransitpulangname; ?>"
                                   value="<?php echo $arrivaltimetransitpulang; ?>">
                            <input type="hidden" name="<?php echo $txbtransitname1pulangname; ?>"
                                   value="<?php echo $transitName1pulang; ?>">
                            <input type="hidden" name="<?php echo $txbtransitname2pulangname; ?>"
                                   value="<?php echo $transitName2pulang; ?>">
                            <input type="hidden" name="<?php echo $txbseatpulangname; ?>"
                                   value="<?php echo $seattransitpulang; ?>">
