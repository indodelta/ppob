...
if($jumlahairline == 0){
    ...
    for ($x = 0; $x < $jumlahairline; $x++) {
        ...
        $jumlahjadwal = count($jadwal[$x]->data);
        ...
        <div class="ibox">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-2">
                        <div class="ibox-tools">
                            <a data-toggle="collapse" data-target="#<?php echo $idibox;?>" class="collapse-link">
            ...
            <div id="<?php echo $idibox;?>" class="ibox-content <?php if($x!=0){echo 'collapse';} ?>">

                <div class="table-responsive tooltip-demo">
                    <table id="datajadwalpesawat" class="table table-bordered table-hover datajadwalpesawat"
                        ...
                        for ($y = 0; $y < $jumlahjadwal; $y++) {
                            ...
                            <!--form pilih penerbangan-->
                                ...
                                <tr class="text-center">
                                    ...
                                    <td style="vertical-align: middle;">
                                        ...
                                        for ($a = 0; $a < $jumlahpesawat; $a++) {
                                            $flightCode = $jadwal[$x]['data'][$y]['detailTitle'][$a]['flightCode'];
                                            ?>
                                            <input type="text" class="text-center" value="<?php echo $flightCode;?>" style="border: none;background-color: transparent; max-width: 50px;"><br/>
                                            <?php
                                        }
                                        ?>
                                    </td>
                                    ...
                                    <td style="vertical-align: middle;">
                                        <text data-toggle="tooltip"
                                            ...
                                            if($istransit == 'true'){
                                                ?>
                                                <a data-toggle="collapse" data-target="#<?php echo $idtransit;?>">
                                    ...
                                    <td style="vertical-align: middle;">
                                        ...
                                        for ($a = 0; $a < $jmlclasses; $a++) {
                                            $price = $jadwal[$x]['data'][$y]['classes'][$a][0]['price'];
                                            $harga = $harga + $price;
                                        }
                                        ?>
                                    ...
                                    <td style="vertical-align: middle;">
                                        <?php
                                        for ($a = 0; $a < $jmlclasses; $a++) {
                                            $availability = $jadwal[$x]['data'][$y]['classes'][$a][0]['availability'];
                                        }
                                        ?>
                                        <form id="<?php echo $namaform; ?>" method="post" target="_blank">
                                            ...
                                            for ($a = 0; $a < $jumlahpesawat; $a++) {
                                                ...
                                                $flightIcon = $jadwal[$x]['data'][$y]['detailTitle'][$a]['flightIcon'];
                                                $flightName = $jadwal[$x]['data'][$y]['detailTitle'][$a]['flightName'];
                                                $flightCode = $jadwal[$x]['data'][$y]['detailTitle'][$a]['flightCode'];
                                                $depart = $jadwal[$x]['data'][$y]['detailTitle'][$a]['depart'];
                                                $origin = $jadwal[$x]['data'][$y]['detailTitle'][$a]['origin'];
                                                $originName = $jadwal[$x]['data'][$y]['detailTitle'][$a]['originName'];
                                                $transitName1 = $originName . ' ( ' . $origin . ' )';
                                                $arriv = $jadwal[$x]['data'][$y]['detailTitle'][$a]['arrival'];
                                                $destination = $jadwal[$x]['data'][$y]['detailTitle'][$a]['destination'];
                                                $destinationName = $jadwal[$x]['data'][$y]['detailTitle'][$a]['destinationName'];
                                                $transitName2 = $destinationName . ' ( ' . $destination . ' )';
                                                $transitTime = $jadwal[$x]['data'][$y]['detailTitle'][$a]['transitTime'];
                                                $class = $jadwal[$x]['data'][$y]['classes'][0][0]['class'];
                                                $seat = $jadwal[$x]['data'][$y]['classes'][0][0]['seat'];
                                                if($jumlahpesawat == $jmlclasses){
                                                    $class = $jadwal[$x]['data'][$y]['classes'][$a][0]['class'];
                                                    $seat = $jadwal[$x]['data'][$y]['classes'][$a][0]['seat'];
                                                }
                                                ...
                                                ?>
                                                <input type="hidden" class="text-center" name="<?php echo $txbflightcodeperginame;?>" value="<?php echo $flightCode;?>">
                                ...
                                <tr id="<?php echo $idtransit; ?>" class="collapse">
                                    <td colspan="7">
