...
class TVKabel extends CI_Controller
{
    ...
    public function index()
    {
        if($this->session->userdata('status') == '') {
            ...
            $this->load->view('TVKabel/form_tvkabel');

        }

    }

    public function open_form_tvkabel()
    {
        $data['dataproduk'] = $this->getdatadenomproduk();
        $this->load->view('TVKabel/form_tvkabel',$data);
    }
    ...
    public function getdatatvkabelproduk()
    {
